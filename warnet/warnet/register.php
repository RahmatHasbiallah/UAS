...
<head>
    ...
    <style>
        body {
            background: url('img/bluebg.jpg') fixed;
...
<body>
    ...
    if(isset($_GET['pesan'])){
        if($_GET['pesan']=="gagal"){
            echo "<div class='alert'>Registrasi gagal. Silahkan coba lagi.</div>";
        }
    }
    ?>
            ...
            <div class="col-md-6">
                <div class="kotak_login">
                    ...
                    <form action="proses_register.php" method="post">
                        ...
                        <button type="submit" class="btn btn-primary btn-block tombol_login">REGISTER</button>
                    </form>
