...
<center>
  <!-- Tambahkan ikon tambah -->
    <a href="tambah3.php" class="btn btn-success"><i class="fas fa-plus-square"></i> Tambah data keuangan</a>
    <br><br>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="ubah3.php?id=<?= $row["id"]; ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Ubah</a>
                    <p></p>
                    <a href="hapus3.php?id=<?= $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus data?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                </td>
